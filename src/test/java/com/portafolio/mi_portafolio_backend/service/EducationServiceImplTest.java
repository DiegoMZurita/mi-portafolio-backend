...
public class EducationServiceImplTest {
    ...
    @InjectMocks
    private EducationServicesImpl educationServices;
    ...
    void testFindAllReturnsListOfEducation(){
        ...
        // Act
        List<Education> result = educationServices.findAll();
    ...
    void testFindByIdReturnsEducationWhenFound(){
        ...
        // Act
        Optional<Education> result = educationServices.findById(educationId);
    ...
    void testSaveEducationThrowsExceptionWhenInvalid(){
        ...
        assertThrows(ValidationException.class, () -> educationServices.save(invalidEducation),
    ...
    void testSaveEducationSavesValidEducation(){
        ...
        //Act
        Education savedEducation = educationServices.save(validEducation);
