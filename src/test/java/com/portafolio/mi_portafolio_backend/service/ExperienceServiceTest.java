...
public class ExperienceServiceTest {
    ...
    void testSaveValidExperience() {
        ...
        assertNotNull(savedExperience.getId(), "El objeto guardado debe tener una ID asignado");
        assertNotNull(experienceService.findById(savedExperience.getId()).orElse(null), "El objeto guardado debe existir en la base de datos");
    }
